...
const defaultProps: ITestProps = {
    ...
    users: [
        { id: "1", firstName: 'firstname', lastName: 'lastName', email: 'user1@example.com' },
    ],
    onClose: mockOnClose,
};
...
const renderComponent = (props: ITestProps) => {
  return render(
      <DataGroupUsersDialog {...props} />
  );
};

describe('DataGroupUsersDialog', () => {
    beforeEach(() => {
        jest.clearAllMocks();
    });
