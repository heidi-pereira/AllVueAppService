using System.Text;
// ReSharper disable All - this is a copy of a file from another project

namespace BrandVue.Controllers.Api
{
    /// <summary>
    /// https://github.com/jawa-the-hutt/lz-string-csharp/blob/master/src/LZString.cs
    /// Modified by David Connell to be thread safe
    /// </summary>
    public class LZString
    {
        ...
        Dictionary<string, Dictionary<char, int>> baseReverseDic = new Dictionary<string, Dictionary<char, int>>();
        ...
        public byte[] compressToUint8Array(string uncompressed)
        {
        ...
        public string decompressFromUint8Array(byte[] compressed)
        {
            if (compressed == null) return "";
            else
            {
        ...
        private string _compress(string uncompressed, int bitsPerChar, GetCharFromInt getCharFromInt)
        {
        ...
        private string _decompress(int length, int resetValue, GetNextValue getNextValue)
        {
