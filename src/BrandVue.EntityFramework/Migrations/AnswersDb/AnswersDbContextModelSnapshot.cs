...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BrandVue.EntityFramework.Answers.Model.ChoiceSet", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ChoiceSetId"), 1L, 1);
            ...
            modelBuilder.Entity("BrandVue.EntityFramework.Answers.Model.Question", b =>
                {
                    ...
                    b.ToTable("Questions", "vue");
                });

            modelBuilder.Entity("BrandVue.EntityFramework.Answers.Model.SurveyGroup", b =>
                {
                    b.Property<int>("SurveyGroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SurveyGroupId"), 1L, 1);
                    ...
                    b.HasKey("SurveyGroupId");

                    b.ToTable("SurveyGroups", "dbo");
                });

            modelBuilder.Entity("BrandVue.EntityFramework.Answers.Model.SurveyGroupSurveys", b =>
                {
                    b.Property<int>("SurveyGroupId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SurveyGroupId", "SurveyId");

                    b.HasIndex("SurveyId");

                    b.ToTable("SurveyGroupSurveys", "dbo");
                });
            ...
            modelBuilder.Entity("BrandVue.EntityFramework.Answers.Model.Surveys", b =>
                {
                    ...
                    b.Property<string>("AuthCompanyId")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("authCompanyId");
            ...
            modelBuilder.Entity("BrandVue.EntityFramework.Answers.Model.SurveySegment", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SurveySegmentId"), 1L, 1);
            ...
            modelBuilder.Entity("BrandVue.EntityFramework.Answers.Model.SurveyGroupSurveys", b =>
                {
                    b.HasOne("BrandVue.EntityFramework.Answers.Model.SurveyGroup", "SurveyGroup")
                        .WithMany("Surveys")
                        .HasForeignKey("SurveyGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BrandVue.EntityFramework.Answers.Model.Surveys", "Survey")
                        .WithMany()
