...
{
    public partial class UpdateMetricAboutTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
ALTER TABLE [dbo].[MetricAbout]
SET (SYSTEM_VERSIONING = OFF)
GO

DROP TABLE [dbo].[MetricAbout_History]
GO

DROP TABLE [dbo].[MetricAbout]
GO

CREATE TABLE [dbo].[MetricAbout](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[ProductShortCode] [nvarchar](20) NOT NULL,
	[MetricName] [nvarchar](450) NOT NULL,
