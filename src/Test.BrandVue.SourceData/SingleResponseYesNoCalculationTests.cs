...
{
    /// <summary>
    /// This tests how an individual response is included in the yes no calculation.
    /// The test cases are generated for all combinations of metric (from TestMeasureProvider),
    /// and all combinations of answers to the primary, secondary, and base fields.
    /// As a result, the test setup is a little complicated.
    /// For simpler calculation engine tests, please see YesNoCalculationTests for an example.
    /// To get started understanding these tests:
    /// * Remove all but one of the items returned from GetAllTestMeasures
    /// * Run SingleResponseTest and observe the test names showing which respondents were tested.
    /// * Debug into one of them and set a breakpoint in BaseMeasureTotalCalculator's outer loop
    /// </summary>
    [TestFixture]
    internal class SingleResponseYesNoCalculationTests
    {
        [Test]
        ...
        {
            var testMeasures = new TestMeasureProvider(CalculationType.YesNo).GetAllTestMeasures();
        ...
        {
            yield return testMetric.WithResponses(new ResponseAnswers(Array.Empty<TestAnswer>(), SurveyId: 0)).ExpectBaseSize(1).ExpectResult(0.0).Named($"{testPrefix}, ResponseDetail: Not in any survey (InBase: True, InPrimary: False)").Build();
            ...
            yield return testMetric.WithResponses(new ResponseAnswers(Array.Empty<TestAnswer>(), SurveyId: 2)).ExpectBaseSize(1).ExpectResult(0.0).Named($"{testPrefix}, ResponseDetail: Survey 2 (InBase: True, InPrimary: False)").Build();
        }

        private static IEnumerable<TestCaseData> WaveMeasure(string testPrefix, TestMetric testMetric)
        {
            yield return testMetric.WithResponses(new ResponseAnswers(Array.Empty<TestAnswer>(), DateTimeOffset.Parse("2018-12-25"))).ExpectBaseSize(1).ExpectResult(0.0).Named($"{testPrefix}, ResponseDetail: Not in any wave (InBase: True, InPrimary: False)").Build();
            ...
            yield return testMetric.WithResponses(new ResponseAnswers(Array.Empty<TestAnswer>(), DateTimeOffset.Parse("2019-03-15"))).ExpectBaseSize(1).ExpectResult(0.0).Named($"{testPrefix}, ResponseDetail: Wave 2 (InBase: True, InPrimary: False)").Build();
        }
        ...
        private static IEnumerable<TestCaseData> NoBaseNoSecondary(string testPrefix, TestMetric testMetric, EntityValue[] primaryEntityValues)
        {
            ...
            yield return noBaseTest.WithResponse(TestAnswer.For(testMetric.PrimaryField, 1, primaryEntityValues)).ExpectBaseSize(1).ExpectResult(1).Named($"{testPrefix}, ResponseDetail: (InBase: True, InPrimary: True)").Build();
            yield return noBaseTest.WithResponse(TestAnswer.For(testMetric.PrimaryField, 2, primaryEntityValues)).ExpectBaseSize(1).ExpectResult(0).Named($"{testPrefix}, ResponseDetail: (InBase: True, InPrimary: False)").Build();
            yield return noBaseTest.WithResponse(TestAnswer.For(testMetric.PrimaryField, 3, primaryEntityValues)).ExpectBaseSize(0).ExpectResult(0).Named($"{testPrefix}, ResponseDetail: (InBase: False, InPrimary: True)").Build();
            yield return noBaseTest.WithResponse(TestAnswer.For(testMetric.PrimaryField, 4, primaryEntityValues)).ExpectBaseSize(0).ExpectResult(0).Named($"{testPrefix}, ResponseDetail: (InBase: False, InPrimary: False)").Build();
        ...
        private static IEnumerable<TestCaseData> HasBaseNoSecondary(string testPrefix, TestMetric testMetric, EntityValue[] primaryEntityValues, EntityValue[] baseEntityValues)
        {
            ...
            yield return withBaseTest.WithResponse(baseTrue, primaryFalse).ExpectBaseSize(1).ExpectResult(0).Named($"{testPrefix}, ResponseDetail: (InBase: True, InPrimary: False)").Build();
            yield return withBaseTest.WithResponse(baseTrue).ExpectBaseSize(1).ExpectResult(0).Named($"{testPrefix}, ResponseDetail: (InBase: True, NoPrimary)").Build();
            ...
            var fieldExpressionWithBaseField = withBaseTest
                ...
                .WithPrimaryField(null);
            yield return fieldExpressionWithBaseField.WithResponse(baseTrue, primaryTrue).ExpectBaseSize(1).ExpectResult(1.0).Named($"{testPrefix} With Variable expression Only, ResponseDetail: (InBase: True, InPrimary: True)").Build();
            yield return fieldExpressionWithBaseField.WithResponse(baseTrue, primaryFalse).ExpectBaseSize(1).ExpectResult(0.0).Named($"{testPrefix} With Variable expression Only, ResponseDetail: (InBase: True, InPrimary: False)").Build();
            yield return fieldExpressionWithBaseField.WithResponse(baseTrue).ExpectBaseSize(1).ExpectResult(0.0).Named($"{testPrefix} With Variable expression Only, ResponseDetail: (InBase: True, NoPrimary)").Build();
            yield return fieldExpressionWithBaseField.WithResponse(baseFalse).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Variable expression Only, ResponseDetail: (InBase: False, NoPrimary)").Build();
            yield return fieldExpressionWithBaseField.WithResponse(baseFalse, primaryTrue).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Variable expression Only, ResponseDetail: (InBase: False, InPrimary: True)").Build();
            yield return fieldExpressionWithBaseField.WithResponse(baseFalse, primaryFalse).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Variable expression Only, ResponseDetail: (InBase: False, InPrimary: False)").Build();
            yield return fieldExpressionWithBaseField.WithResponse(primaryTrue).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Variable expression Only, ResponseDetail: (NoBase, InPrimary: True)").Build();
            yield return fieldExpressionWithBaseField.WithResponse(primaryFalse).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Variable expression Only, ResponseDetail: (NoBase, InPrimary: False)").Build();
            yield return fieldExpressionWithBaseField.WithResponse().ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Variable expression Only, ResponseDetail: (NoBase, NoPrimary)").Build();
            ...
            var baseExpressionWithField = withBaseTest
                    ...
                    .WithBaseField(null);
            yield return baseExpressionWithField.WithResponse(baseTrue, primaryTrue).ExpectBaseSize(1).ExpectResult(1.0).Named($"{testPrefix} With Base Expression Only, ResponseDetail: (InBase: True, InPrimary: True)").Build();
            yield return baseExpressionWithField.WithResponse(baseTrue, primaryFalse).ExpectBaseSize(1).ExpectResult(0.0).Named($"{testPrefix} With Base Expression Only, ResponseDetail: (InBase: True, InPrimary: False)").Build();
            yield return baseExpressionWithField.WithResponse(baseTrue).ExpectBaseSize(1).ExpectResult(0.0).Named($"{testPrefix} With Base Expression Only, ResponseDetail: (InBase: True, NoPrimary)").Build();
            yield return baseExpressionWithField.WithResponse(baseFalse).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base Expression Only, ResponseDetail: (InBase: False, NoPrimary)").Build();
            yield return baseExpressionWithField.WithResponse(baseFalse, primaryTrue).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base Expression Only, ResponseDetail: (InBase: False, InPrimary: True)").Build();
            yield return baseExpressionWithField.WithResponse(baseFalse, primaryFalse).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base Expression Only, ResponseDetail: (InBase: False, InPrimary: False)").Build();
            yield return baseExpressionWithField.WithResponse(primaryTrue).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base Expression Only, ResponseDetail: (NoBase, InPrimary: True)").Build();
            yield return baseExpressionWithField.WithResponse(primaryFalse).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base Expression Only, ResponseDetail: (NoBase, InPrimary: False)").Build();
            yield return baseExpressionWithField.WithResponse().ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base Expression Only, ResponseDetail: (NoBase, NoPrimary)").Build();
            ...
            var baseAndFieldExpression = withBaseTest
                    ...
                    .WithPrimaryExpression(testMetric.FieldExpressionParser.ParseUserNumericExpressionOrNull($"{testMetric.PrimaryField.Name} in [1]"))
                    .WithPrimaryField(null);
            yield return baseAndFieldExpression.WithResponse(baseTrue, primaryTrue).ExpectBaseSize(1).ExpectResult(1.0).Named($"{testPrefix} With Base/Variable expression, ResponseDetail: (InBase: True, InPrimary: True)").Build();
            yield return baseAndFieldExpression.WithResponse(baseTrue, primaryFalse).ExpectBaseSize(1).ExpectResult(0.0).Named($"{testPrefix} With Base/Variable expression, ResponseDetail: (InBase: True, InPrimary: False)").Build();
            yield return baseAndFieldExpression.WithResponse(baseTrue).ExpectBaseSize(1).ExpectResult(0.0).Named($"{testPrefix} With Base/Variable expression, ResponseDetail: (InBase: True, NoPrimary)").Build();
            yield return baseAndFieldExpression.WithResponse(baseFalse).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base/Variable expression, ResponseDetail: (InBase: False, NoPrimary)").Build();
            yield return baseAndFieldExpression.WithResponse(baseFalse, primaryTrue).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base/Variable expression, ResponseDetail: (InBase: False, InPrimary: True)").Build();
            yield return baseAndFieldExpression.WithResponse(baseFalse, primaryFalse).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base/Variable expression, ResponseDetail: (InBase: False, InPrimary: False)").Build();
            yield return baseAndFieldExpression.WithResponse(primaryTrue).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base/Variable expression, ResponseDetail: (NoBase, InPrimary: True)").Build();
            yield return baseAndFieldExpression.WithResponse(primaryFalse).ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base/Variable expression, ResponseDetail: (NoBase, InPrimary: False)").Build();
            yield return baseAndFieldExpression.WithResponse().ExpectBaseSize(0).ExpectResult(0.0).Named($"{testPrefix} With Base/Variable expression, ResponseDetail: (NoBase, NoPrimary)").Build();
        }
        ...
        private static IEnumerable<TestCaseData> NoBaseHasSecondary(string testPrefix, TestMetric testMetric, EntityValue[] primaryEntityValues, EntityValue[] secondaryEntityValues)
        {
            ...
            var secondaryTrueOutsideBase = TestAnswer.For(withSecondary.SecondaryField, 16, secondaryEntityValues);
            ...
            var trueOutside = withSecondary.WithResponse(primaryTrue, secondaryTrueOutsideBase).Named($"{testNamePrefix}(InBase: Primary, InPrimary: True, InSecondary: TrueOutsideBase)");
            ...
            switch (testMetric.FieldOperation)
            {
                case FieldOperation.Minus:
                    yield return trueTrue.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return trueFalse.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return falseTrue.ExpectBaseSize(1).ExpectResult(-1.0).Build();
                    yield return falseFalse.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return outsideTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return trueOutside.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return trueNone.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return noneTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    break;
                case FieldOperation.Or:
                case FieldOperation.Plus:
                    yield return trueTrue.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return trueFalse.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return falseTrue.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return falseFalse.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return outsideTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return trueOutside.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return trueNone.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return noneTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    break;
                case FieldOperation.Filter:
                    yield return trueTrue.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return trueFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseTrue.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return falseFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return outsideTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return trueOutside.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return trueNone.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return noneTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    break;
            }
        }
        ...
        private static IEnumerable<TestCaseData> HasBaseHasSecondary(string testPrefix, TestMetric testMetric, EntityValue[] primaryEntityValues, EntityValue[] secondaryEntityValues, EntityValue[] baseEntityValues)
        {
            ...
            // These are reusable responses in the form basePrimarySecondary.
            // "None" means there is no answer for that field in the response
            ...
            {
                case FieldOperation.Minus:
                    yield return trueTrueTrue.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return trueTrueFalse.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return trueFalseTrue.ExpectBaseSize(1).ExpectResult(-1.0).Build();
                    yield return trueFalseFalse.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return falseTrueTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseTrueFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseFalseTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseFalseFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return trueTrueNone.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return trueFalseNone.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return trueNoneTrue.ExpectBaseSize(1).ExpectResult(-1.0).Build();
                    yield return trueNoneFalse.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return falseTrueNone.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseFalseNone.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseNoneTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseNoneFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return noneTrueTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return noneTrueFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return noneFalseTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return noneFalseFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return noneNoneTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return noneNoneFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return noneTrueNone.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return noneFalseNone.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return noneNoneNone.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    break;
                case FieldOperation.Or:
                case FieldOperation.Plus:
                    yield return trueTrueTrue.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return trueTrueFalse.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return trueFalseTrue.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return trueFalseFalse.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return falseTrueTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                ...
                case FieldOperation.Filter:
                    yield return trueTrueTrue.ExpectBaseSize(1).ExpectResult(1.0).Build();
                    yield return trueTrueFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return trueFalseTrue.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return trueFalseFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseTrueTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseTrueFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseFalseTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseFalseFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return trueTrueNone.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return trueFalseNone.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return trueNoneTrue.ExpectBaseSize(1).ExpectResult(0.0).Build();
                    yield return trueNoneFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseTrueNone.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseFalseNone.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseNoneTrue.ExpectBaseSize(0).ExpectResult(0.0).Build();
                    yield return falseNoneFalse.ExpectBaseSize(0).ExpectResult(0.0).Build();
